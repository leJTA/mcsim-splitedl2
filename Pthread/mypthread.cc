...
// typedef int               clockid_t; // new code
...
// int       pthread_condattr_setclock(pthread_condattr_t*, clockid_t)                                       { return 0; } // new code
...
int pthread_barrier_init(pthread_barrier_t *, pthread_barrierattr_t *, unsigned int)       { return 0; }
int pthread_barrier_destroy(pthread_barrier_t *)                                           { return 0; }
int pthread_barrier_wait(pthread_barrier_t *)                                              { return 0; }
int pthread_barrierattr_init(pthread_barrierattr_t *)                                      { return 0; }
int pthread_barrierattr_destroy(pthread_barrierattr_t *)                                   { return 0; }
int pthread_barrierattr_getpshared(pthread_barrierattr_t *, int *)                         { return 0; }
int pthread_barrierattr_setpshared(pthread_barrierattr_t *, int)                           { return 0; }
