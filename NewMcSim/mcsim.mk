...
all: obj_$(TAG)/newmcsim
	cp -f obj_$(TAG)/newmcsim newmcsim

obj_$(TAG)/newmcsim : $(OBJS) main.cc
	$(CXX) $(CXXFLAGS) -o obj_$(TAG)/newmcsim $(OBJS) main.cc

obj_$(TAG)/%.o : %.cc
	$(CXX) -c $(CXXFLAGS) $(PIN_CXXFLAGS) $(INCS) -o $@ $<

clean:
	-rm -f *.o pin.log newmcsim 
